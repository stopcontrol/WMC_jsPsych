...
var jsPsych = (function() {
  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div style=""><p>Experiment wechselt in den Fullscreen-Modus</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">bereit!</button></div>');
  ...
  function drawProgressBar() {
    $('body').prepend($('<div id="jspsych-progressbar-container"><span>Fortschritt</span><div id="jspsych-progressbar-outer"><div id="jspsych-progressbar-inner"></div></div></div>'));
  }
